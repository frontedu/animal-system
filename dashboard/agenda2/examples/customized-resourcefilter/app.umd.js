...
var calendar = new Calendar({
    ...
    crudManager : {
        ...
        listeners : {
            load() {
                ...
                resourceFilter.value = [resourceFilter.store.getById('hotel')]; // Our custom resource filter.
    ...
    onFilterCriteriaChange() {
        if (calendar.resourceFilter) {
            calendar.resourceFilter.disabled = false; // No params means just re-evaluate the filter.
