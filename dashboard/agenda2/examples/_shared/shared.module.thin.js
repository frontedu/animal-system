import { LocaleManager, Localizable, AsyncHelper, AjaxHelper, DomHelper, Button, Popup, Tooltip, Toast, Widget, BrowserHelper, EventHelper, ResizeHelper, VersionHelper, DataGenerator, Fullscreen, Events, GlobalEvents, Rectangle, TrialButton, Base, Menu } from '../../build/thin/core.module.thin.js?459414';
import '../_shared/product.module.js?459414';
/* global RC */
// Load product config
...
const
    ...
    isModule             = pathName.endsWith('module.html') || (moduleTag?.src.includes('app.module.js?459414')) || (pathName.endsWith('index.html') && isBryntumCom),
...
class Shared extends Localizable(Events()) {
    ...
    constructor() {
        ...
        if (isBryntumCom && !VersionHelper.isTestEnv) {
            const productName = me.product.name == 'schedulerpro' ? 'schedulerPro' : me.product.name;
            console.log(
                `%c TIP! %cYou can access the widget used in the demo on the console using %cwindow.${productName}`,
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?459414' : isUmd ? 'app.umd.js?459414' : 'app.js?459414',
                    items    : [
                        isModule ? 'app.module.js?459414' : isUmd ? 'app.umd.js?459414' : 'app.js?459414'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?459414' : isUmd ? 'app.umd.js?459414' : 'app.js?459414') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?459414')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?459414')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?459414') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?459414"]')) {
            filesStore.add({
                text  : 'resources/app.css?459414',
                value : 'resources/app.css?459414'
            });
        }
