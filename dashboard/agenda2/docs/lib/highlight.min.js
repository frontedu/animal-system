/*!
 ...
 Languages enabled: Bash, CSS, Diff, HTML/XML, JSON, JavaScript, Markdown, PHP, PHP Template, Plain text, SCSS, SQL, Shell Session, TOML/also INI, TypeScript, YAML
 */
...
;function o(e){return l("(?=",e,")")}function l(...e){return e.map((e=>{
    ...
    name:"Shell Session",aliases:["console","shellsession"],contains:[{
        className:"meta",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{
            end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("scss",(()=>{"use strict"
