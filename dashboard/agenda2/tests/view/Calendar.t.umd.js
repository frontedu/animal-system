...
StartTest(t => {
  ...
  t.it('datePicker events property and filtering', async t => {
    ...
    calendar.datePicker.events = 'count'; // Wait for next refresh of DatePicker

    await t.waitFor(() => t.query('.b-calendar-cell .b-cell-events-badge').length === 8); // Badges all correct
    ...
    await t.type(null, 'Review'); // Wait for next refresh of DatePicker

    await t.waitFor(() => t.query('.b-calendar-cell .b-cell-events-badge').length === 3); // Badges update
  ...
  t.it('should align overflow popup correctly in a scrolled page', async t => {
    ...
    t.isApproxPx(xy[1], 240, 10); // Anchor correctly colour matched
