...
StartTest(t => {
  ...
  t.it('Zero length allDay events', async t => {
    ...
    await t.click('[data-ref="prevMonth"]');
    await t.click('[data-ref="prevMonth"]');
    await t.click('[data-ref="prevMonth"]'); // The date must be flagged with one event
    ...
    await t.click('[data-ref="datePicker"] .b-calendar-cell[data-date="2020-05-25"]'); // Event must show in MonthView
    ...
    await t.click('[data-ref="modeSelector"] button:contains(Week)'); // Event must show in WeekView
    ...
    await t.click('[data-ref="yearShowButton"]'); // Event presence show in WeekView

    await t.click('.b-yearview .b-calendar-cell.b-cal-cell-overflow.b-datepicker-1-to-3-events .b-icon.b-fa-birthday-cake'); // Overflow popup must show
